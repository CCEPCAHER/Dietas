...
function mostrarPlanAlimentacion() {
    try {
        ...
        if (window.generarPlanVariado && window.baseDatosAlimentos) {
            ...
            console.log('📊 Usando generador variado con base de datos ampliada');
            try {
    ...
    function inicializarBotones() {
        ...
        async function generarHeaderPDF(datos, fecha) {
            ...
            <div class="cliente-info">
                <div class="cliente-datos"><strong>${nombreCliente}</strong> · ${infoCliente} · <span class="recordatorio-agua">${recordatorioHidratacion}</span></div>
            </div>
        `;
        }
