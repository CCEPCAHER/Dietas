...
function ajustarMacroManual(macro, valor) {
    ...
    if (isNaN(numValor) || numValor < 0) {
        mostrarNotificacion('Por favor introduce un valor numérico válido', 'warning');
        return;
    }
...
window.actualizarDistribucionMacros = function (tipo, valorPorcentaje) {
    ...
    if (isNaN(porcentaje) || porcentaje < 0 || porcentaje > 100) {
        mostrarNotificacion('Por favor introduce un porcentaje válido entre 0 y 100', 'warning');
