...
class GestorAlimentosManager {
    ...
    generarTabla() {
        let html = `
            <div style="overflow: hidden; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); background: white; margin-bottom: 30px;">
                    ...
                    <table class="gestor-table">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">Prot. (g)</th>
                                <th style="text-align: center;">GS (g)</th>
                                <th style="text-align: center;">Hidr. (g)</th>
                                <th style="text-align: center;">Grasas (g)</th>
                                <th style="text-align: center;">Azúc. (g)</th>
        ...
        this.baseDatosFiltrada.forEach((alimento, index) => {
            ...
            html += `
                <tr>
                    ...
                    <td class="col-prot" style="text-align: center;">${proteinas.toFixed(1)}</td>
                    <td style="text-align: center; color: #718096;">${grasasSaturadasDisplay}</td>
                    <td class="col-carb" style="text-align: center;">${hidratos.toFixed(1)}</td>
                    <td class="col-fat" style="text-align: center;">${grasas.toFixed(1)}</td>
                    <td style="text-align: center; color: #718096;">${azucarDisplay}</td>
                    <td class="col-kcal" style="text-align: center;">${calorias}</td>
                    <td class="col-actions">
                        <button title="Editar" style="background: none; border: none; padding: 4px; font-size: 1.1em; margin-right: 4px; opacity: 0.7;" onmouseover="this.style.opacity='1'; this.style.transform='scale(1.1)'" onmouseout="this.style.opacity='0.7'; this.style.transform='scale(1)'" onclick="window.gestorAlimentosManager.editarAlimento(${index})">✏️</button>
                        <button title="Eliminar" style="background: none; border: none; padding: 4px; font-size: 1.1em; opacity: 0.7;" onmouseover="this.style.opacity='1'; this.style.transform='scale(1.1)'" onmouseout="this.style.opacity='0.7'; this.style.transform='scale(1)'" onclick="window.gestorAlimentosManager.eliminarAlimento(${index})">🗑️</button>
                    </td>
                </tr>
            `;
        });
