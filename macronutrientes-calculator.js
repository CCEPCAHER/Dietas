...
const MacronutrientesCalculator = {
    ...
    calcularMacronutrientes(datosUsuario = {}, formulario = {}) {
        ...
        const superavitEntreno = parseFloat(formulario.superavitEntreno?.value || 
                                            datosUsuario.superavitEntreno || 5);
        const superavitDescanso = parseFloat(formulario.superavitDescanso?.value || 
